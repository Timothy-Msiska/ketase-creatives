...
const galleryItems = [
  { id: 1, title: 'Brand Identity', image: 'https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?auto=format&fit=crop&w=800&q=80', link: '/portfolio/brand-identity?category=Branding' },
  { id: 2, title: 'Digital Design', image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80', link: '/portfolio/digital-design?category=Digital' },
  { id: 3, title: 'Campaign Work', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80', link: '/portfolio/campaign-work?category=Campaign' },
  { id: 4, title: 'Social Media Content', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80', link: '/portfolio/social-media-content?category=Design' },
  { id: 5, title: 'Creative Direction', image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80', link: '/portfolio/creative-direction?category=Branding' },
  { id: 6, title: 'Illustration', image: 'https://images.unsplash.com/photo-1473187983305-f615310e7daa?auto=format&fit=crop&w=800&q=80', link: '/portfolio/illustration?category=Design' },
];
